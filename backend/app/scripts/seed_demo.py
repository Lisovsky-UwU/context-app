...
DEMO_PLACES = [
    ("Бар «Стрелка»", "bar", "Москва, Берсеневская набережная, 14с5", 55.7415, 37.6085,
     "Терраса с видом на Храм Христа Спасителя. Идём в тёплый вечер, столик бронировать заранее."),
    ("Кофейня «Филин»", "cafe", "Москва, Покровка, 27", 55.7602, 37.6491,
     "Обжаривают сами, есть фильтр на вынос. Работает с восьми утра."),
    ("Музей русского импрессионизма", "culture", "Москва, Ленинградский проспект, 15с11", 55.7876, 37.5638,
     "Небольшой музей на территории бывшей фабрики «Большевик». По четвергам открыт до девяти."),
    ("Лапшичная «Ку»", "restaurant", "Москва, Большая Никитская, 22/2", 55.7566, 37.6003,
     "Рамен и гёдза, очередь после семи вечера."),
    ("Скалодром «Скала-Сити»", "activity", "Москва, Автозаводская, 18", 55.7062, 37.6572,
     "Трассы для новичков есть, обувь напрокат. Берём с собой воду."),
    ("Ботанический сад МГУ «Аптекарский огород»", "nature", "Москва, проспект Мира, 26с1", 55.7767, 37.6326,
